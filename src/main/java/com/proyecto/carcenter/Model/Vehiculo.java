...
@NamedStoredProcedureQuery(
        ...
        procedureName = "CARCENTER.REGISTRAR_VEHICULOS",
        parameters = {
                ...
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "PAR_PLACA", type = String.class),
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "PAR_COLOR", type = String.class),
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "PAR_MARCA", type = String.class),
